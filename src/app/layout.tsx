...
import imagenWhatsapp from '../../public/images/whatsapp.png'
  ...
  return (
    <html lang="es">
      <body>
        ...
        {children}
        <a href='https://wa.me/message/KHOU4UISGXDND1' target='_blank' style={{ position: 'fixed', bottom: '20px', left: "20px", zIndex: 999, cursor: "pointer" }}>
          <Image src={imagenWhatsapp} alt='whatsapp Boton' style={{
            width: "50px",
            height: "50px",
          }} />
        </a>
